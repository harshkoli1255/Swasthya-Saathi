...
const slides: SlideData[] = [
  {
    ...
    imageAlt: 'Indian patient speaking in Hindi with real-time waveform transcription',
  ...
  },
  {
    ...
    imageAlt: 'Clinical safety dashboard showing deterministic rules RF-001 through RF-007 and risk radar',
    accentColor: '#DC2626',
  ...
  },
  {
    ...
    imageAlt: 'AYUSH clinical intelligence showing Tridosha balance and holistic constitutional markers',
  ...
  },
  {
    ...
    imageAlt: 'ABDM interoperability dashboard showing dual coding between SNOMED CT and NAMASTE ontology',
    accentColor: '#06038D',
  ...
  },
  {
    ...
    imageAlt: 'Indian physician reviewing AI synthesized case sheet on clinic workstation',
